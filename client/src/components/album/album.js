    ...
    return (
        ...
        <div className="album" id="album" >
                    ...
                    <div className='buttonsArea'>
                        ...
                        <a href="https://garyodonnellthedimestoreheroes.bandcamp.com/album/three-ways-from-nowhere" target="_blank" aria-label="open bandcamp"
                            rel="noopener noreferrer" className="albumListdiv">
                            <div className="button" aria-label="open bandcamp to buy the album">BUY THE ALBUM </div>
                        </a>
                        <div className="albumListdiv" style={{ paddingBottom: '40px'}}>
                            <div aria-label="open bandcamp to buy the album" onClick={() => window.location.replace("/#listen")}
                    ...
                    <img src="https://res.cloudinary.com/djtvlgplj/image/upload/v1765044989/gary_at_the_wedge_dad7c2de6e.jpg" alt="Gary at the Wedgewood Rooms" loading="lazy" style={{width: '20rem', height: '20rem'}}/>
                    <div style={{ display: "block", justifyContent: "center", padding: '20px'}}>
                        ...
                        <div>
                        <a href="https://www.wedgewood-rooms.co.uk/events/2026-03-05-gary-odonnell-and-the-dime-store-heroes-the-wedgewood-rooms" aria-label="open wedgewood rooms to buy tickets" target="_blank"
                        rel="noopener noreferrer" className="albumListdiv">
